...
describe("VoteOption", () => {
  ...
  it("renders a <button> element", () => {
    const { container } = render(
      <VoteOption size="m" color="primary" label="Option A" />,
    );
  ...
  it("has aria-pressed=false when not selected", () => {
    const { container } = render(
      <VoteOption size="m" color="primary" label="A" />,
    );
    expect(
  ...
  it("has aria-pressed=true when selected", () => {
    const { container } = render(
      <VoteOption size="m" color="primary" label="A" selected />,
    );
    expect(
      container.querySelector("button")?.getAttribute("aria-pressed"),
    ).toBe("true");
  ...
  it.each(SIZES)("renders size %s without error", (size) => {
    const { container } = render(
      <VoteOption size={size} color="primary" label="A" />,
    );
    expect(container.querySelector("button")).toBeTruthy();
  });
  ...
  it.each(COLORS)("renders color %s without error", (color) => {
    const { container } = render(
      <VoteOption size="m" color={color} label="A" />,
    );
    expect(container.querySelector("button")).toBeTruthy();
  });

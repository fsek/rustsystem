...
export function Spinner({ size, color, className = "" }: SpinnerProps) {
	...
	return (
		<svg
			...
			aria-label="Loading"
		>
			<circle className="opacity-25" cx="12" cy="12" r="10" stroke={colorVar} strokeWidth="4" />
			<path className="opacity-75" fill={colorVar} d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" />
		</svg>
	);
}
